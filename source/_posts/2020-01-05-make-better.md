...
几乎所有人都希望承担第 3 种类型工作。为什么呢——无外乎，节奏更主动，复杂度高，彰显个人的专业价值呗。第 1 和 2 种工作往往被贴上了被动、低价值、重复劳动这些标签。先别急着下结论，这个观点背后是因为不匹配的认知和流程而导致的，如果 1 和 2 不能正确的搞定，不懂业务的你也不可能玩不转所谓的专业数据挖掘任务的。
...
传统上，我们一般定义了数据分析师、数据分析专员这两个角色。但仔细想想这两个名词的字面意义，问题其实非常大，他们居然全是面向数据的，而不是面向解决问题或者价值本身的！
...
![](https://pic-1300049111.cos.ap-beijing.myqcloud.com/img/20200405170504.png)
